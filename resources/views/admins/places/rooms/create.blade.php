                    ...
                    <form method="POST" action="{{ route('rooms.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select
                                        class="form-select select2 status nosearch @error('status') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="overtime_up_4_total" value="{{ old('overtime_up_4_total') }}"
                                            readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="overtime_down_4_total" value="{{ old('overtime_down_4_total') }}"
                                            readonly>
                                        <label class="input-group-text">Jam/m2</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                placeholder="Masukkan Deskripsi" rows="5">{{ old('description') }}</textarea>
