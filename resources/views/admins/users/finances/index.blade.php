<x-app-layout>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Data User Keuangan</h4>
                        ...
                        <div class="col-sm-4">
                            <div class="text-sm-end">
                                <button type="button" class="btn btn-success waves-effect waves-light mb-2"
                                    data-bs-toggle="modal" data-bs-target="#addUserKeuanganModal"><i
                    ...
                    <div class="table-responsive">
                        <table class="table-nowrap table-bordered table align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="text-body fw-bold">K001</td>
    ...
    <!-- Modal Tambah Gedung -->
    <div class="modal fade" id="addUserKeuanganModal" tabindex="-1" aria-labelledby="addUserKeuanganModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="gedungModalLabel">Tambah User Keuangan</h1>
