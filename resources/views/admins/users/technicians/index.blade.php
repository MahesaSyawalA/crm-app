<x-app-layout>
                        ...
                        <div class="col-sm-4">
                            <div class="text-sm-end">
                                <button type="button" class="btn btn-success waves-effect waves-light mb-2"
                                    data-bs-toggle="modal" data-bs-target="#addUserTeknikModal"><i
                    ...
                    <div class="table-responsive">
                        <table class="table-nowrap table-bordered table align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="text-body fw-bold">T001</td>
    ...
    <!-- Modal Tambah Gedung -->
    <div class="modal fade" id="addUserTeknikModal" tabindex="-1" aria-labelledby="addUserTeknikModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="gedungModalLabel">Tambah User Teknik</h1>
