            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                <img src="{{ asset('assets/images/logo-crm.png') }}" alt="" height="36">
                            </span>
                        </a>
                    ...
                    <button type="button" class="btn btn-sm font-size-16 header-item waves-effect px-3"
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item noti-icon waves-effect right-bar-toggle"
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#"><i
                                    class="bx bx-wallet font-size-16 me-1 align-middle"></i> <span
                            ...
                            <a class="dropdown-item" href="#"><i
                                    class="bx bx-lock-open font-size-16 me-1 align-middle"></i> <span
