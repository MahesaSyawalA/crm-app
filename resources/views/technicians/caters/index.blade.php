<x-app-layout>
                        ...
                        <div class="col-sm-4">
                            <div class="text-sm-end">
                                <button type="button" class="btn btn-success waves-effect waves-light mb-2"
                                    data-bs-toggle="modal" data-bs-target="#addUserCaterModal"><i
    ...
    <!-- Modal Tambah Gedung -->
    <div class="modal fade" id="addUserCaterModal" tabindex="-1" aria-labelledby="addUserCaterModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="gedungModalLabel">Tambah User Cater</h1>
